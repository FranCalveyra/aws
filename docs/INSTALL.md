...
Esta guía te va a ayudar a configurar el entorno de desarrollo necesario para trabajar con este repositorio de Arquitectura de Nube en AWS.
...
```toml
[book]
title = "Arquitectura de Nube en AWS"
